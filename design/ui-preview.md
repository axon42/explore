...
- **Reset:** current test clears transcript/questions/findings while retaining the brief; workspace clear removes all meetings. Scope and consequences are explicit. This mock changes browser memory only.
